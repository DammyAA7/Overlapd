          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                if(status1 == 'Order Requested'|| (status2 != null && 'Shopping in progress' == status2)){
                ...
                } else if(status1 == 'Pick up assigned' || (status2 != null && 'Delivery Complete' == status2)){
                    ...
                    TextButton(
                      onPressed: () async{
                        ...
                        await FirebaseFirestore.instance.collection('All Deliveries').doc('Open Deliveries')
                            ...
                            .update({'status': 'Shopping in progress', 'accepted by': _UID, 'orderHandedOver': false});
