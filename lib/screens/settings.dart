      ...
      body: Padding(
        ...
        child: Column(
          children:[
            const Text('Email'),
            Text(email!),
            addressInputBox('First Name', true, false, firstNameController.text, TextInputType.text, (newValue) {
              firstNameController.text = newValue;
              checkForModifications();
            }),
            addressInputBox('Last Name', true, false, lastNameController.text, TextInputType.text, (newValue) {
   ...
   try {
     ...
     if (userSnapshot.exists) {
       ...
       setState(() {
         ...
         firstNameController = TextEditingController(text: userSnapshot['First Name']);
         lastNameController = TextEditingController(text: userSnapshot['Last Name']);
